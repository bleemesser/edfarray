...
Handles EDF, EDF+C, EDF+D, BDF, BDF+C, and BDF+D files of any size without loading them into memory. Files are memory-mapped, signals are lazily decoded, and multi-channel reads are parallelized across cores.
